...
left outer join acc_account_item e on d.field_value = e.code and a.city=e.city
left outer join acc_account_code f on f.code = e.acct_code and a.city=f.city
