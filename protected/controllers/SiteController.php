...
*/
	...
	public function actionCopysetting() {
		$model=new CopysettingForm;

		if(isset($_POST['CopysettingForm'])) {
			$model->attributes=$_POST['CopysettingForm'];
			$model->copy();
			Dialog::message('Info', Yii::t('dialog','Setting copied'));
		}
		$this->render('copysetting',array('model'=>$model));
	}
}
