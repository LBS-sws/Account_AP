...
class AcctItemForm extends CFormModel
{
	...
	{
		$sql = "select * from acc_account_item where code='$index' and city='$city'";
	...
	protected function saveAcctType(&$connection)
	{
		...
		switch ($this->scenario) {
			case 'delete':
				$sql = "delete from acc_account_item where code = :code and city = :city";
				break;
			case 'new':
				$sql = "insert into acc_account_item(
						code, name, item_type, acct_code, city, luu, lcu) values (
						:code, :name, :item_type, :acct_code, :city, :luu, :lcu)";
				break;
			case 'edit':
