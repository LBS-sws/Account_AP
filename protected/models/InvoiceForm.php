...
EOD;
        ...
        $spanHtml ="&nbsp;For Online Payment, kindly transfer to:<br/>";
        $spanHtml.="&nbsp;Bank: OCBC Bank Account: 6958 5958 7001<br/>";
        $spanHtml.="&nbsp;Paynow to UEN: 201621680G";
        $tbl.=<<<EOD
             </table>
             <table border="0" cellspacing="0" cellpadding="0" style="width: 700px;line-height: 20px;">
                  ...
                  <tr><td rowspan="2"><span style="line-height: 11px;">{$spanHtml}</span></td><td></td><td align="right">GST:</td></tr>
                  <tr><td></td><td align="right">Total Amount($):</td></tr>
             </table>
<table border="0" cellspacing="0" cellpadding="0" style="line-height: 20px;text-align: center;">
    <tr><td width="300px" colspan="2" style="line-height: 6px;"></td><td  width="70px;" style="line-height: 6px;"></td><td width="200px;" rowspan="3" border="1"><b>LBS SERVICES (SINGAPORE) PTE LTD</b><br/>***This is computer generated invoice,<br/>no signature is required.***</td></tr>
    <tr><td style="text-align:left;" colspan="2" border="1">  Generated by:$model->generated_by</td><td></td></tr>
    <tr><td align="left">&nbsp;Customer's Copy</td><td></td></tr>
    <tr><td colspan="2" rowspan="2" align="left"><span>&nbsp;</span><img width="86px" height="86px" src="images/invoice_ap_pay.png" /></td><td></td><td>     Authorised Signature  &nbsp; &nbsp; &nbsp; &nbsp;<b>End</b></td></tr>
    <tr><td></td><td style="text-align: right;"><img width="70px" height="50px" src="images/footer_1.jpg" /><img width="78px" height="50px" src="images/footer_2.jpg" /></td></tr>
</table>
EOD;
