...
EOD;
        ...
        $tbl.=<<<EOD
             ...
             <table cellspacing="0" cellpadding="0" style="line-height: 20px;text-align: center;">
                  <tr><td width="110px;"></td><td width="10px;"></td><td rowspan="3" width="250px;"><img src="images/biao.png" ></td><td width="200px;" rowspan="2" border="1"><b>LBS SERVICES (SINGAPORE) PTE LTD</b><br/>***This is computer generated invoice,<br/>no signature is required.***</td></tr>
                  <tr><td><img src="images/biao2.png" ></td><td></td></tr>
