...
class PayReqForm extends CFormModel
{
	...
	public function retrieveData($index)
	{
		...
		$sql = "select *,  
				workflow$suffix.RequestStatus(city,'PAYMENT',id,req_dt) as wfstatus,
				workflow$suffix.RequestStatusDesc(city,'PAYMENT',id,req_dt) as wfstatusdesc,
