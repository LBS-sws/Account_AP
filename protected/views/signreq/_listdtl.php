<?php
	$cls_str = "class='clickable-row' data-href='"
		.$this->getLink('XA07', 'signreq/edit', 'signreq/edit', array('index'=>$this->record['id']))
		."'";
?>
<tr>
...
<?php endif ?>
	<td <?php echo $cls_str;?>>
		<?php
			...
			echo TbHtml::hiddenField($this->getFieldName('city'), $this->record['city']);
		?>
		<?php echo $this->record['req_dt']; ?>
	</td>
	<td <?php echo $cls_str;?>><?php echo $this->record['user_name']; ?></td>
	<td <?php echo $cls_str;?>><?php echo $this->record['trans_type_desc']; ?></td>
	<td <?php echo $cls_str;?>>
		<?php echo $this->record['acct_type_desc']; ?>
	</td>
	<td <?php echo $cls_str;?>><?php echo $this->record['payee_name']; ?></td>
	<td <?php echo $cls_str;?>>
		<?php echo $this->record['pitem_desc']; ?>
	</td>
	<td width='20%' <?php echo $cls_str;?>><?php echo $this->record['item_desc']; ?></td>
	<td <?php echo $cls_str;?>><?php echo $this->record['amount']; ?></td>
	<td <?php echo $cls_str;?>><?php echo $this->record['ref_no']; ?></td>
	<td <?php echo $cls_str;?>><?php echo $this->record['int_fee']; ?></td>
	<td>
		<?php 
			echo TbHtml::button($this->record['payrealcountdoc'], 
				array(
					'class'=>'btn-xs',
					'onclick'=>'javascript:showreal('.$this->record['id'].');',
				)
			);
		?>
	</td>
