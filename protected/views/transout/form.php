				...
				<div class="col-sm-7">
					<?php 
						if ($model->isReadOnly()) {
							...
							echo $form->dropDownList($model, 'acct_id', General::getAccountList($model->city)); 
					?>
				</div>
			</div>
...
$('#TransInForm_payer_type').on('change', function() {
	...
	";
$js .= Script::genLookupButtonEx('btnPayer', '*', 'payer_id', 'payer_name',array(),false,array('incity'=>'TransInForm_city'));
