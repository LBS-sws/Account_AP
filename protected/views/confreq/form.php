<?php
$this->pageTitle=Yii::app()->name . ' - Payment Request Confirmation Form';
?>
...
<section class="content-header">
	<h1>
		<strong><?php echo Yii::t('trans','Payment Request Confirmation Form'); ?></strong>
	</h1>
<!--
	<ol class="breadcrumb">
...
<section class="content">
	...
	<div class="btn-group" role="group">
		<?php echo TbHtml::button('<span class="fa fa-reply"></span> '.Yii::t('misc','Back'), array(
				'submit'=>Yii::app()->createUrl('confreq/index'))); 
		?>
		<?php echo TbHtml::button('<span class="fa fa-check"></span> '.Yii::t('misc','Confirm'), array(
			'submit'=>Yii::app()->createUrl('confreq/approve')));
		?>
...
?>
<?php $this->renderPartial('//confreq/reason',array('model'=>$model,'form'=>$form)); ?>
