...
<?php else: ?>
					<?php 
						$list = array_merge(array(''=>Yii::t('misc','-- None --')), General::getTransTypeList($model->city,'OUT'));
...
$('#PayReqForm_payee_type').on('change', function() {
	...
	";
$js .= Script::genLookupButtonEx('btnPayee', '*', 'payee_id', 'payee_name', array(), false, array('incity'=>'PayReqForm_city'));
...
$js = Script::genLookupButtonEx('btnPaidItem', 'accountitemout', 'item_code', 'pitem_desc', 
		...
		false,
		array('acctid'=>'PayReqForm_acct_id','incity'=>'PayReqForm_city')
	);
